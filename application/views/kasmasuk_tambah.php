    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data</li>
         <li class="active">Tambah kas_masuk</li>
      </ol>
    </section>
<div class="container-fluid" style="padding-top: 20px;">
	<h3>Tambah Data Kas Masuk</h3>
	<form action="<?=base_url('Kasmasuk/simpan') ?>" method="POST">
		...
		<div class="form-group">
			...
			<input type="number" name="jumlah" class="form-control" placeholder="Rp. x,xxx,xxx">
		</div>
